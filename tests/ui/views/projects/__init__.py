...
def assert_actual_equals_expected_project(expected, actual):
    ...
    assert actual.project_status_id == expected.project_status_id
    assert actual.theme_id == expected.theme_id
    assert actual.ukcrc_health_category_id == expected.ukcrc_health_category_id
    assert actual.nihr_priority_area_id == expected.nihr_priority_area_id
    assert actual.ukcrc_research_activity_code_id == expected.ukcrc_research_activity_code_id
    assert actual.racs_sub_category_id == expected.racs_sub_category_id
    assert actual.research_type_id == expected.research_type_id
    assert actual.methodology_id == expected.methodology_id
    assert actual.expected_impact_id == expected.expected_impact_id
    assert actual.trial_phase_id == expected.trial_phase_id
    assert actual.main_funding_source_id == expected.main_funding_source_id
    assert actual.main_funding_category_id == expected.main_funding_category_id
    assert actual.main_funding_dhsc_nihr_funding_id == expected.main_funding_dhsc_nihr_funding_id
    assert actual.main_funding_industry_id == expected.main_funding_industry_id
...
def convert_project_to_form_data(project):
    result = {
        ...
        "first_in_human": project.first_in_human,
        "link_to_nihr_transactional_research_collaboration": project.link_to_nihr_transactional_research_collaboration,
        "crn_rdn_portfolio_study": project.crn_rdn_portfolio_study,
        "rec_approval_required": project.rec_approval_required,
        "randomised_trial": project.randomised_trial,
        "project_status_id": project.project_status_id,
        "theme_id": project.theme_id,
        "ukcrc_health_category_id": project.ukcrc_health_category_id,
        "nihr_priority_area_id": project.nihr_priority_area_id,
        "ukcrc_research_activity_code_id": project.ukcrc_research_activity_code_id,
        "racs_sub_category_id": project.racs_sub_category_id,
        "research_type_id": project.research_type_id,
        "methodology_id": project.methodology_id,
        "expected_impact_id": project.expected_impact_id,
        "trial_phase_id": project.trial_phase_id,
        "main_funding_source_id": project.main_funding_source_id,
        "main_funding_category_id": project.main_funding_category_id,
        "main_funding_dhsc_nihr_funding_id": project.main_funding_dhsc_nihr_funding_id,
        "main_funding_industry_id": project.main_funding_industry_id,
    }
