import pytest
from coredash.model.finance_upload import WORKSHEET_NAME_INVESTIGATORS, FinanceUpload
from tests.ui.views.finance_upload.test_upload import FakeFinanceUpload, assert__finance_upload_error, upload_post_file
...
def test__post__missing_worksheet(client, faker, loggedin_user_finance_uploader, standard_lookups):
    ...
    file.investigators_name = 'NIHR Not Investigators'
    ...
    assert__finance_upload_error(row=None, message=f"Missing worksheet '{WORKSHEET_NAME_INVESTIGATORS}'")
